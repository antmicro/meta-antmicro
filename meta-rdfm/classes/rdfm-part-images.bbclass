...
"
_RDFM_SD_IMAGE_DEPENDS_append_mender-uboot = " u-boot:do_deploy"
_RDFM_SD_IMAGE_DEPENDS_append_mender-systemd-boot = " \
    systemd-boot:do_deploy \
    ${IMAGE_BASENAME}:do_uefiapp_deploy \
"
do_image_flash_sdimg[depends] += "${_RDFM_SD_IMAGE_DEPENDS}"

IMAGE_TYPEDEP_flash_sdimg:append = " ${ARTIFACTIMG_FSTYPE} dataimg bootimg"
